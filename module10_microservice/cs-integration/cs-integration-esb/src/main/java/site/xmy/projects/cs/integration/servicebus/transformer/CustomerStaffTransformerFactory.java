package site.xmy.projects.cs.integration.servicebus.transformer;

import site.xmy.projects.cs.integration.domain.OutsourcingSystemDTO;
import site.xmy.projects.cs.integration.servicebus.transformer.beijing.BeijingCustomerStaffTransformer;
import site.xmy.projects.cs.integration.servicebus.transformer.hangzhou.HangzhouCustomerStaffTransformer;
import site.xmy.projects.cs.integration.servicebus.transformer.shanghai.ShanghaiCustomerStaffTransformer;
